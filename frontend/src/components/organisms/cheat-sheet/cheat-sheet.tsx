...
const sections: SheetSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "スレッド選択",
        description: "サイドバーのスレッドを音声で選択",
        voice: "「スレッド1」「スレッド3を開いて」",
      },
      {
        label: "ペイン分割",
        description: "新しいセッションでパネルを追加（無制限）",
        voice: "「分割して」「画面分割」「ペイン分割」",
      },
      {
        label: "パネルフォーカス",
        description: "指定パネルにフォーカスを切り替え",
        voice: "「パネル1」「パネル2」「ペイン3」",
      },
      {
        label: "パネル閉じる",
        description: "指定パネルまたは現在のパネルを閉じる",
        voice: "「パネル2閉じて」「パネル閉じて」",
      },
      {
        label: "分割解除",
        description: "全パネルを閉じて1画面に戻す",
